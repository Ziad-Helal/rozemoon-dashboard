...
import { ApiError, AuthenticateStockRefill_Request, CreateStockRefill_Request, GetStock_Response, GetStockRefills_Response, Pagination } from "@/types/api-types";
...
export function getStock(requestBody: Pagination) {
  return postRequest<Pagination, GetStock_Response, ApiError>(endpoints.getStock, requestBody);
}
