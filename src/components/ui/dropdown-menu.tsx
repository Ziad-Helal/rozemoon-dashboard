  ...
  ({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 space-y-1 text-popover-foreground shadow-md",
...
>(({ className, children, checked, ...props }, ref) => {
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      {...props}
    >
      <span className={cn("absolute flex size-3.5 items-center justify-center", handleDirectionChange(i18n.dir(), "left-2", "right-2"))}>
...
>(({ className, inset, ...props }, ref) => {
  const { i18n } = useTranslation();
  return <DropdownMenuPrimitive.Label ref={ref} className={cn("px-2 py-1.5 text-sm font-semibold", inset && "pl-8", className)} dir={i18n.dir()} {...props} />;
});
