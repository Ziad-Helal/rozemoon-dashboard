...
import type { AuthenticatedUser, FastOrder, GetFastOrders_Response, GetScheduledOrders_Response, ScheduledOrder } from "@/types/api-types";
...
export default function CreateDamageInvoice_Page() {
  ...
  return (
    <Form_Page heading={t("forms.damageInvoice.heading")}>
      {userRole == "StoreKeeper" || (userRole == "Cashier" && order) ? (
